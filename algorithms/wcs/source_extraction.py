...
# solves from, so it lives in algorithms.skylib_lite. Note that the ATLAS
# path does NOT use it; that backend runs its own self-contained scipy
# extractor at algorithms.skylib_lite.astrometry.atlas.extract.sources. This module is
