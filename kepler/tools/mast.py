...
from kepler.config import DEFAULT_MAX_OBSERVATIONS, FITS_DOWNLOAD_DIR, PREVIEW_ROWS
from kepler.models import ToolResult, coerce_optional_int
...
def search_mast(
    ...
    *,
    ...
    products into ``fits_downloads/`` -- the directory name and gitignore
    entry ``database_tools.py`` used.
    """
