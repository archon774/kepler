...
proximity search, wildcards -- see ``catalogs/ads.py`` and the ADS guide for
...
- Most ADS fields come back as single-element lists per row (some, like
  ``author``, genuinely multi-valued) -- ``catalogs.ads.flatten_value``
...
from catalogs.ads import ADS_REVIEW_FIELDS, ADS_SEARCH_FIELDS, flatten_value, format_citation
