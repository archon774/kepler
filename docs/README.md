...
| [`working/`](working/README.md) | Plans under active development, one per file. One track in flight: the rebrand from Kepler to MARS. The MCP tool surface landed on 2026-09-25 and is archived. |
