...
| TUI | [tui-harness.md](tui-harness.md) | Phase C complete; B and D–G pending | `agent/tui-harness` off `dev` | Model backends phases -1 to 3, and the merged stateless optical rollout | The Textual `kepler` console |
